...
public class Test_User_Name_Present_In_Single_User implements AutomationConstants {
			...
			try
			{
				...
				try {
				   ...
				   // driver.navigate().to("http://localhost:5173/about-us");
				    ...
				    String expectedAboutTitle = "Single User | ECODERS";
					...
					WebElement all = driver.findElement(By.xpath("//p[text()='nshilpanmurthy@gmail.com']/../h3"));
					all.click();
					try {
				    	wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[@class='border-t border-gray-200 divide-y divide-gray-100']/div[1]/dd"), NameList));
