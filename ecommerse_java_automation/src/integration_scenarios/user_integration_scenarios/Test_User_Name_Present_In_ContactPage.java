...
public class Test_User_Name_Present_In_ContactPage implements AutomationConstants {
	...
	public static void main(String[] args) 
	{
			...
			try
			{
				...
				String expectedTitle = "Contact Us | ECODERS";
				...
				try {
				   ...
				   // driver.navigate().to("http://localhost:5173/about-us");
				    ...
				    driver.navigate().to(urlOfContact);
				    driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
